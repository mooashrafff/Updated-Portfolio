...
const InternshipCard = () => {
  const openMail = () => {
    window.open(`mailto:${personal.internship.contactEmail}` , '_blank');
  };
    ...
    >
      ...
      <div className="mb-6 flex flex-col items-center sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-4">
          ...
          <div className="bg-muted h-16 w-16 overflow-hidden rounded-full shadow-md">
            <img
              src={personal.avatar.squareAvatarSrc}
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              {personal.internship.duration} – starting {personal.internship.startDate}
            </p>
          </div>
        </div>
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              {personal.internship.locationPreference}
            </p>
          </div>
        </div>
          ...
          <div className="w-full">
            ...
            <div className="text-muted-foreground grid grid-cols-1 gap-y-1 text-sm sm:grid-cols-2">
              <ul className="decoration-none list-disc pl-4">
                <li>{personal.internship.stack}</li>
              </ul>
              <ul className="list-disc pl-4">
                <li>{personal.internship.focus}</li>
                <li>
                  <a
      ...
      <div className="mt-10">
        ...
        <p className="text-foreground text-sm">
          {personal.internship.whatIBring}
        </p>
      </div>
